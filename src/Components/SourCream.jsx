  ...
  return (
    ...
    <div className='border-end ' style={{paddingRight:'50px'}}>
        ...
        transition={{ duration: 0.4 }}>
         <h3 className='text-white font-semibold' style={{marginTop:'90px', marginLeft:'50px'}}> Cheddar & Sour Flavor</h3><br/><span className='text-white font-semibold' style={{ marginLeft:'50px'}}>Price-1200ks</span>
        </motion.div>
        ...
        >
         ...
         <img src="/img/sour1.jpg" alt="" className=' rounded-circle' style={{ height:'330px' , width:"390px", marginTop:'70px', marginLeft:'85px'}} /> 
        ...
        >
         ...
         <img src="/img/sour cream.jpg" alt="" style={{ height:'390px' , width:"450px", marginTop:'50px', marginRight:'300px'}} /> 
